<x-livewire.layout>
    ...
    <x-slot name="header">
        <x-livewire.components.header from_to_color="from-red-800 to-red-400 shadow-lg" name="Recurring Expense"
            description="Manage your subscriptions and recurring bills easily.">
            <x-slot name="button">
                <a wire:navigate href="/expenses/create"
                    class="bg-neutral-800 hover:bg-neutral-700 text-white px-6 py-3 rounded-lg font-semibold transition flex items-center gap-2">
            ...
            @foreach ($recurringExpenses as $expense)
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition">
                    ...
                    <div class="p-6 {{ $expense->category ? '' : 'bg-gradient-to-r from-gray-500 to-gray-600' }}"
                        @if ($expense->category) style="background: linear-gradient(135deg, {{ $expense->category->color }} 0%, {{ $expense->category->color }}dd 100%);" @endif>
                        <div class="flex items-start justify-between">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <button wire:click="deleteRecurringExpense({{ $expense->id }})"
                                    wire:confirm="Are you sure you want to delete this recurring expense?"
                                    class="p-2 bg-white/20 hover:bg-white/30 rounded-lg text-white transition">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span
                                class="text-2xl font-bold text-gray-900">${{ number_format($expense->amount, 2) }}</span>
                        </div>
    ...
    @else
        ...
        <div class="bg-white rounded-xl shadow-md p-12 text-center">
            ...
            <p class="text-gray-600 mb-6">Set up recurring expenses like subscriptions, rent, or utilities to track
