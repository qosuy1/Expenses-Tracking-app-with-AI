<x-livewire.layout>
    ...
    <x-slot name="header">
        <x-livewire.components.header from_to_color="from-red-800 to-red-400 shadow-lg" name="{{ $isEdit ? 'Edit' : 'Create New' }} Expense"
            description="Create or edit your expenses with ease.">
            <x-slot name="button">
                <a wire:navigate href="/expenses"
    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <a href="/expenses"
                class="px-6 py-3 border border-gray-300  rounded-lg text-gray-700 font-semibold hover:bg-gray-400 transition">
                Cancel
            </a>
            <button type="submit"
                class="px-8 py-3 bg-gradient-to-r from-red-800 to-red-600 text-white rounded-lg font-semibold hover:shadow-lg transition transform hover:-translate-y-0.5 flex items-center gap-2">
