<x-livewire.layout>
    <x-slot name="header">
        <x-livewire.components.header from_to_color="from-red-800 to-red-400 shadow-lg" name="Expenses"
            description="manage and track your expenses effectively.">
            <x-slot name="button">
            ...
            <table class="w-full">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            is Recurring
                            <flux:icon.arrow-path-rounded-square class="size-4 d inline " />
                        </th>
                            ...
                            <td colspan="6" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <a href="/expenses/create"
                                        class="bg-neutral-800 hover:bg-neutral-700 dark:bg-purple-600 dark:hover:bg-purple-700 text-white px-6 py-2 rounded-lg font-semibold transition">
