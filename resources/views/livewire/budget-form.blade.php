<x-livewire.layout>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="bg-white  dark:bg-neutral-800 rounded-xl shadow-md p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select wire:model.live.debounce.300ms="month" id="month"
                    ...
                    <div>
                        ...
                        <select wire:model.live.debounce.300ms="year" id="year"
            ...
            <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-md p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select wire:model.live="category_id" id="category_id" wire:click="updateCategoryId"
                        ...
                        <div class="flex items-center justify-between mb-2">
                            ...
                            @if ($hasHistoricalData && $month && $year && !$isEdit)
                                <button type="button" wire:click="getAIRecommendation" wire:loading.attr="disabled"
                                    ...
                                    <svg wire:loading.remove wire:target="getAIRecommendation" class="w-4 h-4"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                                    </svg>
                                    <svg wire:loading wire:target="getAIRecommendation" class="animate-spin w-4 h-4"
                                    ...
                                    <span wire:loading.remove wire:target="getAIRecommendation">✨ Get AI
                                        Suggestion</span>
                            ...
                            <div class="grid grid-cols-3 gap-4 mb-4">
                                ...
                                <button type="button" wire:click="applyRecommendation('recommended')"
                                    ...
                                    <p class="text-2xl font-bold">
                                        ${{ number_format($aiRecommendation['recommended'], 0) }}</p>
                                </button>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="text-right">
                                    ...
                                    <p class="text text-indigo-600 mt-1">
                                        {{ \Carbon\Carbon::create($year, $month, 1)->daysInMonth }} Days
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <ul class="text-sm text-blue-800 space-y-1">
                            ...
                            @else
                                <li>• <strong>Category budgets:</strong> Get detailed control over specific spending
                                    areas</li>
                            @endif
                        </ul>
                    </div>
            ...
            <div class="flex items-center justify-between">
                <a href="/budgets"
                    class="px-6 py-3 border border-gray-300 rounded-lg text-gray-700 dark:text-gray-300 font-semibold hover:bg-gray-50 dark:hover:bg-gray-40 transition">
                    Cancel
                </a>
                <button type="submit"
